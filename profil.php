      ...
      <div class="jumbotron">
		...
		<form class="form-horizontal" method="post" action="profil.php">
			<fieldset>
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="nomClient">Nom </label>  
				  <div class="col-md-4">
		...
		<form class="form-horizontal" method="post" action="profil.php">
			<fieldset>
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="prenomClient">Prénom </label>  
				  <div class="col-md-4">
		...
		<form class="form-horizontal" method="post" action="profil.php">
			<fieldset>
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="ancienMdp">Ancien mot de passe </label>  
				  <div class="col-md-4">
				  <input id="ancienMdp" placeholder="Ancien mot de passe" name="ancienMdp" class="form-control input-md" required="" type="text">
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-md-4 control-label" for="nouveauMdp1">Nouveau mot de passe </label>  
				  <div class="col-md-4">
				  <input id="nouveauMdp1" placeholder="Ancien mot de passe" name="nouveauMdp1" class="form-control input-md" required="" type="text">
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-md-4 control-label" for="nouveauMdp2">Nouveau mot de passe (répéter)</label>  
				  <div class="col-md-4">
				  <input id="nouveauMdp2" placeholder="Ancien mot de passe" name="nouveauMdp2" class="form-control input-md" required="" type="text">
				  </div>
				</div>
				<!-- Button -->
				<div class="form-group">
